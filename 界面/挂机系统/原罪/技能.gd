...
func _ready() -> void:
	...
	if Engine.is_editor_hint():
		return
	纹理=计划.数据技能树(技能文本,"图标代码")
	技能最大等级=计划.数据技能树(技能文本,"最大等级")
	前置技能=计划.数据技能树(技能文本,"前置技能")
	更新等级标签()
...
func 处理样式() -> void:
	...
	样式.样式数组[1].margin_top=-110+int(100*(技能等级*1.0/技能最大等级))
