...
func _draw() -> void:
	...
	#pos = Vector2(
		...
		#size.y - stack_num_font.get_descent(stack_num_font_size) - stack_num_margin-stack_num_font_size)
	#draw_string(stack_num_font, pos, 罗马数字, HORIZONTAL_ALIGNMENT_RIGHT, -1, stack_num_font_size, stack_num_color)
