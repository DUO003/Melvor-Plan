...
func 初始化存档():
	...
	if not 梅存档.has("金币"):
		梅存档["金币"]=0
	字典结构(梅存档["挂机"],
	["任务数据","任务进度","体力","在线时间","红点存档","背包与商店","装备栏","快速移动关系","窗口","随身商店","全局图钉","订单"],
	["窗口禁用","窗口解锁","窗口禁用",])
...
func 窗口状态管理(窗口名称,条目,修改=null):
	var 窗口数据:Dictionary = 梅存档["挂机"][窗口名称]
	if 修改!=null:
		窗口数据[条目]=修改
