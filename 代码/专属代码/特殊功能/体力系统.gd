...
func 生成动态文本():
	...
	var 体力图标:String="[img=50x33]res://素材/游戏素材/食品包/体力蛋糕.png[/img]"
	var 体力 = 体力图标+tr("体力恢复速度%d点/%d分钟")%[恢复量,体力恢复速度]
	var 门票图标:String="[img=40x30]res://素材/游戏素材/货币/17.png[/img]"
	var 门票 = 门票图标+tr("门票")+":"+",".join(门票名)
	%"扩展信息".text="%s\n%s" % [体力,门票]# 拼接文本
func 更新进度条():
